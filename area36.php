    ...
    <ul class="list-group">
      ...
      <li class="list-group-item">
        <div class="d-flex bd-highlight">
          ...
          <div class="p-2 flex-grow-1 bd-highlight">Data informasi kepegawaian unit kerja telah dimutakhirkan secara berkala</div>
      ...
      <div class="collapse" class="collapse w-100 mb-2" id="collapseExample" style="margin: 0 0;">
        <div>
          <iframe class="w-100" height="800px" src="file/3/6.a SIM ASN.pdf" frameborder="0"></iframe>
        </div>
      </div>
